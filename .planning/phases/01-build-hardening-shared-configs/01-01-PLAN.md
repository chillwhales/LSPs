...
Note: No build step needed for this package. Both unbuild (via jiti) and vitest (via Vite) consume .ts files natively. The subpath exports point directly to source .ts files.
