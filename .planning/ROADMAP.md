...
### Phase 07.1: Rename lsp30 to lsp31, copy LICENSE to all packages, remove prepublish postpublish LICENSE scripts (INSERTED)
...
| 07.1 | Rename lsp30→lsp31, LICENSE to packages, remove prepublish/postpublish | RENAME-01, LICENSE-01, LICENSE-02 | ⬚ Not Started (INSERTED) |
