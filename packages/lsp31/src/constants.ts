 ...
 */
export const LSP31_RESERVED_PREFIX = "0x0031" as const;
 ...
 */
export const MIN_LSP31_URI_LENGTH = 82;
 ...
 */
export const LSP31_BACKENDS = ["ipfs", "s3", "lumera", "arweave"] as const;
 ...
 */
export const LSP31_MIN_ENTRIES = 2;
