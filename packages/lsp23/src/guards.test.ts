...
describe("isUniversalProfileInitStruct", () => {
	it("should return true for valid Universal Profile init structs", () => {
		expect(isUniversalProfileInitStruct(validUniversalProfileInitStruct)).toBe(
			true,
		);
	});
	...
	it("should return true for minimal valid structs with zero funding and empty hex", () => {
		expect(
			isUniversalProfileInitStruct(minimalValidUniversalProfileInitStruct),
		).toBe(true);
	});
	...
	it("should return true for various valid hex calldata", () => {
		const validCalldata = ["0x", "0x1234", "0xabcdef", `0x${"ff".repeat(100)}`];
	...
	it("should return false for objects with invalid field types", () => {
		...
		const invalidAddress = {
			...validUniversalProfileInitStruct,
			implementationContract: 123,
		};
		const invalidCalldata = {
			...validUniversalProfileInitStruct,
			initializationCalldata: 123,
		};
	...
	it("should return false for objects with invalid address format", () => {
		const invalidAddresses = [
			...
			{
				...validUniversalProfileInitStruct,
				implementationContract: "1234567890123456789012345678901234567890",
			}, // missing 0x
			{
				...validUniversalProfileInitStruct,
				implementationContract: "0xgg34567890123456789012345678901234567890",
			}, // invalid hex
		];
...
describe("isKeyManagerInitStruct", () => {
	...
	it("should return true for various valid hex values", () => {
		const validHexValues = ["0x", "0x1234", "0xabcdef", `0x${"aa".repeat(50)}`];
	...
	it("should return false for objects with invalid field types", () => {
		...
		const invalidExtraParams = {
			...validKeyManagerInitStruct,
			extraInitializationParams: null,
		};
