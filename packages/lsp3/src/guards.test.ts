...
describe('isLsp3ProfileSchema', () => {
  ...
  it('should return true for profiles with multiple links, assets, and images', () => {
    const profileWithMultiples = {
      ...
      avatar: [validAsset, { ...validAsset, url: 'https://example.com/another.pdf' }],
      profileImage: [validImage, { ...validImage, url: 'https://example.com/another.png' }],
      backgroundImage: [validImage],
    };
  ...
  it('should return false for objects with invalid field types', () => {
    ...
    const invalidProfileImage = { ...validLsp3Profile, profileImage: 'not an array' };
    const invalidBackgroundImage = { ...validLsp3Profile, backgroundImage: 'not an array' };
  ...
  it('should return false for arrays with invalid items', () => {
    ...
    const invalidLinks = { ...validLsp3Profile, links: [{ invalidField: 'value' }] };
    const invalidAvatar = { ...validLsp3Profile, avatar: [{ invalidField: 'value' }] };
    const invalidProfileImage = { ...validLsp3Profile, profileImage: [{ invalidField: 'value' }] };
    const invalidBackgroundImage = { ...validLsp3Profile, backgroundImage: [{ invalidField: 'value' }] };
